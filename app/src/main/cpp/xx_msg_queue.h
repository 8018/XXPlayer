...
#ifndef XXPLAYER_XX_MESSAGE_H
#define XXPLAYER_XX_MESSAGE_H
...
inline static void msg_queue_put_simple1(MessageQueue *q, int
what) {
    AVMessage msg;
    msg_init_msg(&msg);
    msg.
...
inline static void msg_queue_put_simple2(MessageQueue *q, int
what,
                                         int arg1
) {
    AVMessage msg;
...
inline static void msg_queue_put_simple3(MessageQueue *q, int
what,
                                         int arg1,
                                         int arg2
) {
...
inline static void msg_queue_put_simple4(MessageQueue *q, int
what,
                                         int arg1,
                                         int arg2,
                                         void *obj,
    ...
    msg.
            arg2 = arg2;
    msg.
            obj = av_malloc(obj_len);
    memcpy(msg
                   .obj, obj, obj_len);
    msg.
            free_l = msg_obj_free_l;
    msg_queue_put(q, &msg
    );
}
...
inline static int msg_queue_get(MessageQueue *q, AVMessage *msg, int
block) {
    AVMessage *msg1;
    int ret;
...
inline static void msg_queue_remove(MessageQueue *q, int
what) {
